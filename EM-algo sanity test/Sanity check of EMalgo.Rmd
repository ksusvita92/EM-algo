...
ggplot(cleanData) + geom_boxplot(aes(x=EMcomp,y=abs(est_alpha-true_alpha),fill=status),alpha=.3) + 
  facet_wrap(~k) + xlab("EM-algo components") + ylab("error alpha") +
  theme(legend.position="bottom", legend.title=element_blank())
ggplot(cleanData) + geom_boxplot(aes(x=EMcomp, y=abs(est_beta-true_beta), fill=status), alpha=.3) +
  facet_wrap(~k) + xlab("EM-algo components") + ylab("error beta") +
  theme(legend.position="bottom", legend.title=element_blank())
